...
import com.iks.codewars.phoneDirectory.PhoneDirTest.{dr, testing}
import org.scalatest.Assertions.assertResult
import org.scalatest.flatspec.AnyFlatSpec

class PhoneSpec extends AnyFlatSpec {
...
object PhoneDirTest {
  val dr: String = "/+1-541-754-3010 156 Alphand_St. <J Steeve>\n 133, Green, Rd. <E Kustur> NY-56423 ;+1-541-914-3010\n" +
  ...
  def testing(s: String, ph: String, exp: String): Unit = {
    val actual: String = PhoneDir.phone(s, ph)
