package com.iks.codewars.morsecode.decode
...
com.iks.codewars.morsecode.decode.MorseDecoder.decode(".... . -.--   .--- ..- -.. .")
...
Elm: com.iks.codewars.morsecode.decode.MorseCodes.get : Dict String String
...
object MorseCodes {
  val morseCodes: Map[String, Char] = Map(".-" -> 'A', "...." -> 'H', "." -> 'E', "-.--" -> 'Y', ".---" -> 'J', "..-" -> 'U', "-.." -> 'D')
}
